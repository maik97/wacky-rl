...
from wacky.memory import MemoryDict, NumpyMemoryDict
...
class DQN(ReinforcementLearnerArchitecture):
    ...
    def __init__(
        ...
        self.memory = NumpyMemoryDict().set_maxlen(buffer_size)
    ...
    def learn(self):
        ...
        for epoch in range(self.epochs):
            for batch in self.memory.generate_batches(self.batch_size, num_batches=1):
    ...
    def warm_up(self, env, num_steps=50_000):
        ...
        print('warm-up:', t+1,
              ...
              'actions:', self.memory.read('actions', reduce='mean', decimals=3),
